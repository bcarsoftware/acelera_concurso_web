...
import type {
    NoteSubjectResponse,
    NoteTopicResponse,
    PublicTenderResponse, QuestionResponse,
    StudyTipsResponse,
    SubjectResponse,
    TopicResponse
} from "../../../data/data";
...
import {QuestionsScreenSolver} from "~/pages/dashboard/question/questions-screen-solver";
...
export default function Index() {
    ...
    const [questionsGenerated, setQuestionsGenerated] = useState<QuestionResponse | undefined>(undefined);
    const [showSolveQuestionScreen, setShowSolveQuestionScreen] = useState<boolean>(false);
    /* QUESTIONS GENERATED BY AI */
    ...
    const hiddenScreens = () => {
        ...
        setShowSolveQuestionScreen(false);
    }
    /* HIDDEN REGISTERS AND SEE MAIN PAGE */
    ...
    const accessQuestionsPage = () => (<QuestionsDashboardPage
        ...
        settingQuestions={setQuestionsGenerated}
        setSolveQuestionScreen={setShowSolveQuestionScreen}
        currentScreen={setQuestions}
    />);
        ...
        <MainDashboardTag>
            <LeftPanel
                ...
                setQuestions={(value: boolean) => {
                    ...
                    setSelectedPublicTender(undefined);
                    setSelectedSubject(undefined);
                    setSelectedTopic(undefined);
                    setSelectedNoteSubject(undefined);
                    setSelectedNoteTopic(undefined);
                }}
            ...
            <Content>
                ...
                {showSolveQuestionScreen && (accessQuestionsSolveScreen())}
